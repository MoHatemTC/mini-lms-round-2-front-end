...
const contacts = [
  ...
  },
  {
    ...
    lastMessage: "Has anyone finished module 4?",
    time: "Yesterday",
    unread: 0,
    online: false,
  },
  {
    ...
    lastMessage: "The new syllabus is up.",
    time: "Tue",
    unread: 0,
    online: true,
  },
...
const messages = [
  {
    ...
    senderId: "1",
    avatar: "https://i.pravatar.cc/150?img=1",
    text: "Hi Alex! I reviewed your recent submission for the Compound Components assignment.",
    time: "10:30 AM",
    isMe: false,
  },
  {
    ...
    text: "Oh great, thanks! How did it look?",
    time: "10:32 AM",
    isMe: true,
  },
  {
    ...
    senderId: "1",
    avatar: "https://i.pravatar.cc/150?img=1",
    text: "Your implementation of the Context API was spot on. Very clean architecture.",
    time: "10:35 AM",
    isMe: false,
  },
  {
    ...
    senderId: "1",
    avatar: "https://i.pravatar.cc/150?img=1",
    text: "Great job on the assignment! Keep it up.",
    time: "10:42 AM",
    isMe: false,
  },
];
      ...
      <div className="flex-1 flex flex-col bg-background relative">
        ...
        <div className="h-16 shrink-0 border-b border-border bg-card flex items-center justify-between px-4 sm:px-6 z-10 shadow-sm">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            <button className="h-9 w-9 rounded-xl flex items-center justify-center text-text-secondary hover:text-foreground hover:bg-muted transition-colors">
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6 scrollbar-hide">
          <div className="text-center">
            <span className="text-xs font-medium text-text-secondary bg-muted px-3 py-1 rounded-full border border-border">
              Today
            </span>
          </div>
              ...
              >
                {!msg.isMe && (
                  <div className="w-8 shrink-0">
                    {showAvatar && (
                      <Avatar src={msg.avatar} className="h-8 w-8" />
                    )}
                  </div>
                )}
        ...
        <div className="p-4 sm:p-6 bg-card border-t border-border">
          <div className="flex items-end gap-2 bg-muted/30 border border-border rounded-[24px] p-2 focus-within:ring-2 focus-within:ring-primary/50 focus-within:border-primary/50 transition-all shadow-sm">
            <div className="flex gap-1 pb-1 px-1">
              <button className="h-8 w-8 rounded-full flex items-center justify-center text-text-secondary hover:text-foreground hover:bg-muted transition-colors">
            ...
            <div className="flex gap-1 pb-1 pr-1">
              ...
              {inputText.length > 0 ? (
                <button className="h-8 w-8 rounded-full bg-primary text-white flex items-center justify-center shadow-md hover:scale-105 transition-transform">
