          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div className="max-w-2xl">
              ...
              <p className="text-text-secondary text-base sm:text-lg mb-6 leading-relaxed">
                You're in the top 5% of active learners this week. Keep up the
                momentum! You have{" "}
                <strong className="text-foreground">2 assignments</strong> due
                soon.
              </p>
              ...
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="p-6 flex flex-col justify-center flex-1">
                  ...
                  <h3 className="font-bold text-lg text-foreground mb-1">
                    Module 4: Concurrent Rendering
                  </h3>
                  <p className="text-sm text-text-secondary line-clamp-1 mb-4">
                    Learn how useTransition and useDeferredValue work under the
                    hood.
                  </p>
              ...
              {[
                {
                  ...
                  duration: "8h 20m",
                  rating: 4.9,
                  img: "https://images.unsplash.com/photo-1618477247222-accd0b1aa41d?w=400&h=250&fit=crop",
                },
                {
                  ...
                  duration: "5h 45m",
                  rating: 4.8,
                  img: "https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=400&h=250&fit=crop",
                },
              ].map((course, i) => (
                <Card
                  key={i}
        ...
        <div className="lg:col-span-1 space-y-6 sm:space-y-8">
          ...
          <motion.div variants={itemVariants}>
            <Card className="p-5 border-border bg-card shadow-sm">
              ...
              <div className="space-y-4">
                {[
                  {
                    title: "Compound Components Refactor",
                  ...
                  <div
                    key={i}
                    className="flex gap-3 items-start p-3 rounded-xl hover:bg-muted/50 transition-colors border border-transparent hover:border-border cursor-pointer"
                  >
                    <div
                      className={cn(
                        "mt-0.5 h-2 w-2 rounded-full shrink-0",
                        item.urgent ? "bg-danger" : "bg-amber-500",
                      )}
                    />
                    <div className="flex-1 min-w-0">
                      ...
                      <p
                        className={cn(
                          "text-xs font-medium",
                          item.urgent ? "text-danger" : "text-text-secondary",
                        )}
                      >
                        Due: {item.due}
                      </p>
              ...
              <Link to="/learner/calendar">
                <Button
                  variant="ghost"
                  className="w-full mt-4 text-xs font-bold text-primary hover:text-primary hover:bg-primary/5"
                >
          ...
          <motion.div variants={itemVariants}>
            <Card className="p-5 border-border bg-card shadow-sm">
              ...
              <p className="text-xs text-text-secondary mb-4">
                You're on track to hit your learning goal this week!
              </p>
