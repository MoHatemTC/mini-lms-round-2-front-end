...
const mockDownloads = [
  ...
  {
    id: "d2",
    title: "Module 1: Introduction (Offline Video)",
  ...
  {
    id: "d3",
    title: "Dataset_Marketing_Campaign.csv",
    ...
    <div className="space-y-6 pb-12 max-w-[1000px] mx-auto">
        ...
        <div className="flex justify-between items-end mb-2">
          <div>
            ...
            <p className="text-sm text-text-secondary mt-1">
              Files downloaded for offline access
            </p>
          </div>
      ...
      <Card className="overflow-hidden border-border bg-card">
        <div className="p-4 border-b border-border bg-background/50 flex items-center justify-between">
          ...
          <Button
            variant="outline"
            className="border-danger/20 text-danger hover:bg-danger/10 bg-background hidden sm:flex"
          >
          ...
          {filteredDownloads.map((item) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 sm:gap-6">
                ...
                <Badge
                  variant="success"
                  className="hidden sm:inline-flex bg-success/10 text-success border-0 px-2 py-0.5"
                >
