...
import { Flame, Star, Zap, Crown, Target } from "lucide-react";
...
const badges = [
  ...
  },
  {
    id: 5,
    name: "Night Owl",
    description: "Learned past midnight",
    icon: "🦉",
    color: "bg-indigo-500",
    earned: false,
    progress: 0,
      ...
      <Card className="p-6 sm:p-10 border-border bg-card shadow-premium relative overflow-hidden flex flex-col md:flex-row items-center gap-8 md:gap-12">
        ...
        <div className="relative shrink-0 flex items-center justify-center">
          <svg className="w-40 h-40 transform -rotate-90">
            ...
            <circle
              ...
              strokeDasharray={465}
              strokeDashoffset={
                465 - 465 * (userStats.xp / userStats.nextLevelXp)
              }
        ...
        <div className="flex-1 text-center md:text-left z-10">
          ...
          <p className="text-text-secondary mb-6">
            You need {userStats.nextLevelXp - userStats.xp} XP to reach Level{" "}
            {userStats.level + 1}. Complete lessons and quizzes to earn more.
          </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
              ...
              >
                <Card
                  className={cn(
                    ...
                    badge.earned
                      ? "bg-card shadow-sm hover:shadow-premium hover:-translate-y-1"
                ...
                >
                  ...
                  <p className="text-[10px] text-text-secondary mb-3 leading-tight flex-1">
                    {badge.description}
                  </p>
                  ...
                  {badge.earned ? (
                    <Badge
                      variant="secondary"
                      className="bg-primary/10 text-primary border-0 text-[10px] w-full justify-center"
                    >
                      Earned {badge.date}
                    </Badge>
                  ) : (
        ...
        <div className="space-y-6">
              ...
              >
                <div className="w-6 text-center font-bold text-text-secondary">
                  {user.rank === 1 ? (
                    ...
                    <Crown className="h-5 w-5 text-slate-400 mx-auto" />
                  ) : user.rank === 3 ? (
                ...
                <Avatar
                  ...
                  className={cn(
                    "h-10 w-10 border-2",
                    user.isUser ? "border-primary" : "border-transparent",
                  )}
                />
          ...
          <Card className="p-5 border-border bg-card shadow-sm relative overflow-hidden group cursor-pointer">
            ...
            <h4 className="font-bold text-sm text-primary uppercase tracking-wider mb-1">
              Daily Challenge
            </h4>
