...
const notes = [
  {
    time: "02:15",
    text: "Important: The render phase is pure and has no side effects.",
  },
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        ...
        <div className="h-14 shrink-0 border-b border-border bg-background/80 backdrop-blur-md flex items-center justify-between px-4 sticky top-0 z-20">
          <div className="flex items-center gap-3">
            <Link
              to="/learner/courses/1"
              className="p-2 -ml-2 rounded-lg hover:bg-muted text-text-secondary hover:text-foreground transition-colors"
            >
          ...
          <div className="flex items-center gap-2">
            <Button
              variant="outline"
              size="sm"
              className="hidden sm:flex h-8 rounded-lg border-border"
            >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-black/50 flex flex-col justify-between p-4 sm:p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            ...
            <div className="space-y-4 mt-auto transform translate-y-[10px] group-hover:translate-y-0 transition-transform duration-300">
              ...
              <div className="flex items-center justify-between px-2">
                ...
                <div className="flex items-center gap-4">
                  <button className="text-white/80 hover:text-white text-xs font-bold bg-white/10 backdrop-blur-sm px-2 py-1 rounded">
                    1x
                  </button>
                  <button className="text-white/80 hover:text-white transition-colors">
                  ...
                  <div className="space-y-8">
                    <div className="prose prose-sm sm:prose-base dark:prose-invert max-w-none text-foreground/90">
                      <p className="text-lg leading-relaxed">
                        In this lesson, we will dive deep into how React
                        processes updates and renders them to the screen.
                        Understanding this pipeline is crucial for writing
                      ...
                      <ul className="space-y-2">
                        ...
                        <li className="flex items-center gap-2">
                          <div className="h-1.5 w-1.5 rounded-full bg-primary" />{" "}
                          How reconciliation works under the hood
                        </li>
                        <li className="flex items-center gap-2">
                          <div className="h-1.5 w-1.5 rounded-full bg-primary" />{" "}
                ...
                {activeTab === "notes" && (
                  <div className="space-y-6">
                    <div className="flex gap-3">
                      ...
                      <Button className="btn-gradient h-12 rounded-[16px] px-6 text-white shadow-sm font-bold">
                        Save Note
                      </Button>
                    </div>
                        ...
                        >
                          <div className="flex items-start justify-between gap-4">
                            <div className="flex items-start gap-3">
                              <Badge
                                variant="secondary"
                                className="bg-primary/10 text-primary border-primary/20 font-mono text-[10px] mt-0.5 shadow-sm"
                              >
                                {note.time}
                              </Badge>
                            ...
                            <Button
                              variant="ghost"
                              size="sm"
                              className="h-8 w-8 p-0 opacity-0 group-hover:opacity-100 transition-opacity text-danger hover:text-danger hover:bg-danger/10"
                            >
          ...
          >
            ...
            <div className="h-14 shrink-0 border-b border-border flex items-center justify-between px-5 bg-background/50 backdrop-blur-md">
              ...
              <button
                ...
                className="p-1.5 rounded-lg hover:bg-muted text-text-secondary transition-colors"
              >
            ...
            <div className="p-5 border-b border-border bg-card">
              ...
              <ProgressBar
                ...
                className="h-2"
                indicatorClassName="bg-primary shadow-[0_0_8px_rgba(20,184,166,0.6)]"
              />
            </div>
                  ...
                  >
                    ...
                    >
                      <div className="flex flex-col items-start gap-1">
                        <h3 className="font-bold text-sm text-foreground text-left tracking-tight">
                          {module.title}
                        </h3>
                              ...
                              >
                                {item.status === "current" && (
                                  <motion.div
                                    ...
                                    className="absolute left-0 top-0 bottom-0 w-1 bg-primary rounded-r-full shadow-[0_0_10px_rgba(20,184,166,0.5)]"
                                  />
                                )}
