...
const mockPaths = [
  {
    ...
    description:
      "Master HTML, CSS, JavaScript, and modern frameworks like React to build interactive web applications.",
    icon: Code,
  ...
  },
  {
    ...
    description:
      "Learn design principles, wireframing, prototyping, and master Figma for professional product design.",
    icon: Palette,
  ...
  },
  {
    ...
    description:
      "From Python basics to advanced neural networks and deep learning models.",
    icon: Database,
  ...
  },
  {
    ...
    description:
      "SEO, SEM, Social Media, and Analytics. Everything you need to grow a business online.",
    icon: LineChart,
            ...
            <Card className="h-full border-border bg-card hover:shadow-md transition-shadow flex flex-col overflow-hidden relative group">
              ...
              <div className="p-6 sm:p-8 flex-1 flex flex-col">
                <div className="flex items-start justify-between mb-4">
                  <div
                    className={cn(
                      "h-14 w-14 rounded-2xl flex items-center justify-center mb-2",
                      path.bgColor,
                    )}
                  >
                  ...
                  {path.progress > 0 && path.progress < 100 && (
                    <Badge
                      variant="outline"
                      className="bg-background/80 border-primary/30 text-primary"
                    >
                      In Progress
                    </Badge>
                  )}
                ...
                {path.progress > 0 ? (
                  ...
                  <div className="mt-auto pt-6 border-t border-border">
                    <Button
                      variant="outline"
                      className="w-full h-11 bg-background border-border hover:bg-muted/50 transition-colors"
                    >
                      Start Path
                    </Button>
                  </div>
