    ...
    <div className="min-h-[80vh] flex flex-col items-center justify-center p-6 text-center">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        <Link to="/">
          <Button
            variant="outline"
            className="h-12 px-8 rounded-xl border-border bg-background shadow-sm group"
          >
      ...
      <div className="mt-16 text-text-secondary text-sm">
        ...
        <kbd className="mx-1 px-2 py-1 bg-muted rounded border border-border font-mono text-xs">
          Ctrl + K
        </kbd>{" "}
        to search.
      </div>
