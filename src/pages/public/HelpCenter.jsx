      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          },
          {
            ...
            desc: "Manage your profile and payments.",
          },
          {
            icon: <MessageCircle className="h-8 w-8 text-primary" />,
            title: "Course Help",
            desc: "Troubleshoot video and course issues.",
          },
          {
            icon: <LifeBuoy className="h-8 w-8 text-primary" />,
            title: "Community",
            desc: "Guidelines and community support.",
          },
        ].map((item, i) => (
          <Card
            key={i}
        ...
        <div className="space-y-4">
          <Accordion title="How do I reset my password?">
            <div className="p-4 text-text-secondary leading-relaxed">
              ...
              Password". Enter your registered email address and we will send
              you a secure link to create a new password.
            </div>
          </Accordion>
          <Accordion title="Can I download course videos?">
            <div className="p-4 text-text-secondary leading-relaxed">
              Currently, video downloads are only available on our mobile
              application for offline viewing. Desktop downloads are not
              supported to protect the copyright of our instructors.
            </div>
          </Accordion>
          <Accordion title="How do I get my certificate?">
            <div className="p-4 text-text-secondary leading-relaxed">
              Once you complete 100% of the lessons in a course, your
              certificate will automatically be generated and available in the
              "Certificates" tab of your dashboard.
            </div>
          </Accordion>
        </div>
      </div>
