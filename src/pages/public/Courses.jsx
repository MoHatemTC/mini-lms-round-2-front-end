      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg text-text-secondary">
            Level up your skills with world-class instructors. Find the perfect
            course to advance your career today.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-card p-4 rounded-2xl border border-border shadow-sm">
          ...
          <div className="flex gap-2 w-full md:w-auto overflow-x-auto hide-scrollbar">
            {["All", "Development", "Design", "Data Science", "Marketing"].map(
              (cat) => (
                <Button
                  key={cat}
                  variant={cat === "All" ? "default" : "outline"}
                  className={
                    cat === "All" ? "bg-primary text-white" : "bg-background"
                  }
                >
                  {cat}
                </Button>
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <div className="mt-auto">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-border">
                      ...
                      <Button
                        size="sm"
                        className="btn-gradient rounded-lg text-white"
                      >
                        View Details
                      </Button>
                    </div>
