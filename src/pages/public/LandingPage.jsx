...
const features = [
  {
    ...
    description:
      "Personalized learning paths powered by AI that adapts to your pace, style, and goals in real-time.",
  ...
  },
  {
    ...
    description:
      "Earn industry-recognized certificates that boost your resume and validate your expertise globally.",
  ...
  },
  {
    ...
    description:
      "Build real-world projects with guided exercises, code reviews, and portfolio-ready deliverables.",
  ...
  },
  {
    ...
    description:
      "Structured learning paths aligned with industry demands, from beginner to job-ready professional.",
  ...
  },
  {
    ...
    description:
      "Learn from industry leaders at Google, Meta, Netflix, and top universities worldwide.",
  ...
  },
  {
    ...
    description:
      "Join a vibrant community of 150,000+ learners. Collaborate, discuss, and grow together.",
...
const courses = [
  ...
  {
    id: 3,
    title: "Complete UI/UX Design Masterclass 2025",
...
const learningPaths = [
  {
    ...
    steps: ["HTML & CSS", "JavaScript", "React", "TypeScript", "Next.js"],
    duration: "6 months",
    courses: 12,
  ...
  },
  {
    ...
    steps: ["Node.js", "Databases", "REST APIs", "GraphQL", "Microservices"],
    duration: "7 months",
    courses: 14,
  ...
  {
    title: "AI Engineer",
    steps: ["Python", "ML Basics", "Deep Learning", "NLP", "MLOps"],
    duration: "9 months",
    courses: 16,
  ...
  },
  {
    ...
    steps: ["Linux", "Networking", "AWS", "Kubernetes", "Terraform"],
    duration: "8 months",
    courses: 15,
  ...
  {
    title: "Data Analyst",
    steps: ["SQL", "Excel", "Python", "Tableau", "Statistics"],
    duration: "5 months",
    courses: 10,
...
const testimonials = [
  {
    ...
    rating: 5,
    review:
      "Learnify completely transformed my career. The curriculum quality rivals top bootcamps at a fraction of the cost. I went from zero coding knowledge to a Senior Frontend role in 18 months.",
  ...
  },
  {
    ...
    rating: 5,
    review:
      "The AI-powered learning paths are incredible. They adapted to my learning style and pace perfectly. The hands-on projects gave me portfolio pieces that impressed every interviewer.",
  ...
  },
  {
    ...
    rating: 5,
    review:
      "The cloud computing track is world-class. From fundamentals to advanced architecture patterns, every lesson was practical and immediately applicable to my daily work.",
...
const faqs = [
  {
    ...
    a: "Our free plan gives you lifetime access to 50+ courses, community forums, and basic features. No credit card required to sign up. You can upgrade anytime to unlock our full course library.",
  },
  {
    q: "Can I switch plans at any time?",
    a: "Absolutely! You can upgrade, downgrade, or cancel your plan at any time. Changes take effect at the start of your next billing cycle. No hidden fees or lock-in contracts.",
  },
  {
    q: "Are the certificates recognized by employers?",
    a: "Yes! Our certificates are industry-recognized and trusted by 5,000+ companies worldwide including Google, Microsoft, Amazon, and Meta. Each certificate has a unique verification link.",
  },
  {
    q: "What if I'm not satisfied with a course?",
    a: "We offer a 30-day money-back guarantee on all paid plans. If you're not completely satisfied, contact our support team for a full refund — no questions asked.",
  },
  {
    q: "Do you offer team or company plans?",
    a: "Yes! Our Enterprise plan is designed for teams and organizations. It includes team management tools, custom learning paths, SSO integration, and dedicated support.",
  },
  {
    q: "Can I learn on mobile?",
    a: "Absolutely! Learnify is available on iOS, Android, and web. Download courses for offline learning and sync your progress across all devices seamlessly.",
  },
];
  ...
  return (
    <div className="overflow-hidden">
      ...
      >
        ...
        <div
          className="absolute bottom-20 right-10 w-96 h-96 bg-secondary/10 rounded-full blur-[120px] animate-pulse-glow"
        ...
        <div className="absolute top-32 right-[15%] hidden lg:block">
          <motion.div
            ...
            className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary/20 to-secondary/20 border border-primary/10 backdrop-blur-sm"
          />
        </div>
        <div className="absolute bottom-40 left-[10%] hidden lg:block">
          <motion.div
            ...
            className="w-20 h-20 rounded-full bg-gradient-to-br from-accent/20 to-primary/10 border border-accent/10 backdrop-blur-sm"
          />
        </div>
        <div className="absolute top-[60%] right-[8%] hidden lg:block">
          <motion.div
            ...
            className="w-12 h-12 rounded-xl bg-gradient-to-br from-secondary/20 to-accent/20 border border-secondary/10 backdrop-blur-sm rotate-45"
          />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            Get certified, build projects, and advance your career with
      ...
      <Section className="py-24 border-y border-border bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-6 mb-16 opacity-40 dark:opacity-30">
            {["Google", "Microsoft", "Amazon", "Meta", "Netflix", "Apple"].map(
              (name) => (
                <span
                  key={name}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              From AI-powered personalization to industry-recognized
              certifications, we have built every tool you need to succeed.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, i) => (
              ...
              >
                <div
                  className={`absolute inset-0 rounded-[24px] bg-gradient-to-br ${feature.color} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                />
                <div className="relative">
                  <div
                    className={`h-12 w-12 rounded-2xl bg-gradient-to-br ${feature.color} flex items-center justify-center mb-6`}
                  >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {categories.map((cat, i) => (
              ...
              >
                ...
                >
                  <div
                    className={`inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br ${cat.gradient} mb-4 text-white group-hover:scale-110 transition-transform duration-300`}
                  >
              ...
              >
                ...
                <div className="relative aspect-[16/10] overflow-hidden">
                  ...
                  <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between opacity-0 group-hover:opacity-100 transition-all duration-300">
                    <span className="text-xs font-medium text-white bg-primary/90 px-2.5 py-1 rounded-lg">
                      {course.difficulty}
                    </span>
                    <span className="text-xs font-medium text-white bg-black/50 px-2.5 py-1 rounded-lg">
                      {course.duration}
                    </span>
                  </div>
                </div>
                ...
                <div className="p-5">
                  ...
                  <h3 className="font-bold mt-1 mb-3 line-clamp-2 text-sm leading-snug group-hover:text-primary transition-colors">
                    {course.title}
                  </h3>
      ...
      <Section className="py-24 bg-card border-y border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
              Structured paths to{" "}
              <span className="text-gradient">your dream career</span>
            </h2>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Follow our expert-designed roadmaps from beginner to professional.
              Each path is a curated sequence of courses.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {learningPaths.map((path, i) => (
              ...
              >
                <div
                  className={`h-2 w-16 rounded-full bg-gradient-to-r ${path.color} mb-6`}
                />
                ...
                <div className="space-y-2 mb-6">
                  {path.steps.map((step, si) => (
                    <div key={step} className="flex items-center gap-3">
                      <div
                        className={`h-6 w-6 rounded-full flex items-center justify-center text-xs font-bold ${si === 0 ? "bg-primary text-white" : "bg-muted text-text-secondary"}`}
                      >
                        {si + 1}
                      </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-border text-sm text-text-secondary">
                  ...
                  <span className="flex items-center gap-1">
                    <BookOpen className="h-3.5 w-3.5" /> {path.courses} courses
                  </span>
                </div>
              </motion.div>
            ))}
          ...
          <div className="relative rounded-[32px] overflow-hidden">
            ...
            <div className="relative z-10 py-20 px-8 sm:px-16 text-center text-white">
              ...
              <p className="text-white/80 text-lg max-w-xl mx-auto mb-10">
                Join 150,000+ professionals already learning on Learnify. Start
                your journey today — completely free.
              </p>
