...
export default function LessonsList() {
  ...
  const getTypeIcon = (type) => {
    switch (type) {
      ...
      default:
        return <BookOpen className="h-4 w-4 text-text-secondary" />;
    }
  };
            ...
            <div className="divide-y divide-border">
              {module.lessons
                ...
                .map((lesson) => (
                  <div
                    key={lesson.id}
                    className="p-4 sm:px-5 flex items-center justify-between group hover:bg-muted/10 transition-colors"
                  >
                      ...
                      <div>
                        <div className="font-medium text-foreground text-sm flex items-center gap-2">
                          ...
                          {lesson.isPreview && (
                            <Badge
                              variant="outline"
                              className="h-[18px] text-[10px] px-1 border-primary/30 text-primary"
                            >
                              Preview
                            </Badge>
                          )}
