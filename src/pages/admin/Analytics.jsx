...
const studentGrowth = [
  ...
  { name: "Aug", new: 400, returning: 500 },
  { name: "Sep", new: 500, returning: 550 },
  { name: "Oct", new: 600, returning: 600 },
  { name: "Nov", new: 700, returning: 650 },
  { name: "Dec", new: 800, returning: 700 },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6 hover:shadow-premium transition-shadow duration-300">
          <div className="mb-6">
            ...
            <p className="text-sm text-text-secondary">
              Percentage of students finishing the course
            </p>
          </div>
