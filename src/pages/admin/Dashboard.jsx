...
const revenueData = [
  ...
  { name: "Aug", total: 68000 },
  { name: "Sep", total: 81000 },
  { name: "Oct", total: 85000 },
  { name: "Nov", total: 92000 },
  { name: "Dec", total: 105000 },
];
...
const upcomingTasks = [
  ...
  {
    id: 2,
    title: "Weekly instructor payouts",
    time: "2:00 PM",
    priority: "High",
    type: "Finance",
  },
...
/* ============================================================
   COMPONENTS
   ============================================================ */
function KPICard({ title, value, icon: Icon, trend, trendValue, index }) {
      ...
      <Card className="p-6 hover:shadow-premium transition-shadow duration-300 relative overflow-hidden group">
        ...
        <div className="mt-4 flex items-center gap-2 relative">
          <Badge
            ...
            className="gap-1 px-1.5 py-0.5 rounded-md font-medium text-xs border-0 bg-opacity-10"
          >
            {isPositive ? (
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <Button
            variant="outline"
            size="sm"
            className="hidden sm:flex h-9 rounded-xl border-border hover:bg-muted"
          >
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-text-secondary">
                Monthly revenue across all courses
              </p>
            </div>
        ...
        <Card className="col-span-1 lg:col-span-2 overflow-hidden hover:shadow-premium transition-shadow duration-300">
          <div className="p-6 border-b border-border flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-text-secondary">
                Latest purchases across all courses
              </p>
            </div>
            <Link to="/admin/users">
        ...
        <Card className="p-0 overflow-hidden flex flex-col hover:shadow-premium transition-shadow duration-300">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3">
            {upcomingTasks.map((task) => (
              <div
                key={task.id}
                className="p-4 rounded-xl border border-border bg-card hover:border-primary/30 transition-colors group flex items-start gap-4"
              >
                <div
                  className={cn(
