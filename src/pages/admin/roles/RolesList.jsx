...
const mockRoles = [
  ...
  },
  {
    ...
    users: 45,
    status: "active",
    description: "Can grade assignments and moderate discussions.",
    permissions: 15,
    isSystem: false,
  },
  {
    ...
    users: 15230,
    status: "active",
    description: "Can view and consume enrolled courses.",
    permissions: 8,
    isSystem: true,
  },
  {
    ...
    users: 12,
    status: "active",
    description: "Can moderate reviews and community forums.",
    permissions: 12,
    isSystem: false,
  },
  {
    ...
    users: 8,
    status: "inactive",
    description: "Read-only access to user profiles for support.",
    permissions: 10,
    isSystem: false,
  },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div
          className={cn(
            ...
            viewMode === "matrix"
              ? "lg:col-span-1"
              : "lg:col-span-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 space-y-0",
          )}
        >
          <AnimatePresence>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-0.5">
                          ...
                          {role.isSystem && (
                            <Badge
                              variant="outline"
                              className="h-5 text-[10px] px-1.5 border-primary/30 text-primary"
                            >
                              System
                            </Badge>
                          )}
