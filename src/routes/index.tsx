...
const CoursesList = React.lazy(() => import('../pages/admin/courses/CoursesList'));
...
const AdminAssignments = React.lazy(() => import('../pages/admin/assignments/index'));
const AdminLessons = React.lazy(() => import('../pages/admin/courses/LessonsList'));
const AdminQuizzes = React.lazy(() => import('../pages/admin/courses/QuizBuilder'));
const AdminCertificates = React.lazy(() => import('../pages/admin/CertificatesList'));
...
const CourseDetails = React.lazy(() => import('../pages/learner/CourseDetails'));
...
const LearnerCertificates = React.lazy(() => import('../pages/learner/Certificates'));
const LearnerQuizzes = React.lazy(() => import('../pages/learner/Quizzes'));
const LearnerAssignments = React.lazy(() => import('../pages/learner/Assignments'));
const LearnerAchievements = React.lazy(() => import('../pages/learner/Achievements'));
...
const LearnerCategories = React.lazy(() => import('../pages/learner/Categories'));
const Notifications = React.lazy(() => import('../pages/learner/Notifications'));
const ProfileSettings = React.lazy(() => import('../pages/learner/ProfileSettings'));
