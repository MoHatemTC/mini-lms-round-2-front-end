...
import { 
  ...
  Command, ChevronRight, LayoutDashboard 
} from 'lucide-react';
...
export function AdminHeader({ setIsMobileOpen, isCollapsed }: AdminHeaderProps) {
      ...
      <div className="flex flex-1 items-center justify-end gap-x-4 self-stretch lg:gap-x-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="flex items-center gap-3 p-1 rounded-full hover:bg-muted transition-colors">
            <Avatar src="https://i.pravatar.cc/150?img=5" alt="Admin" className="h-8 w-8 rounded-full border border-border shadow-sm" />
