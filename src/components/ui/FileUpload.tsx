...
export function FileUpload({ accept, maxSize = 10, onUpload, className }: FileUploadProps) {
    ...
    <div className={cn("w-full", className)}>
      {!file ? (
        ...
        >
          ...
          <p className="text-xs text-text-secondary mt-4">Maximum file size: {maxSize}MB</p>
        </div>
      ) : (
