    ...
    items: [
      {
        ...
        icon: MonitorPlay,
        href: "/learner/courses/1",
      },
      {
        id: "2",
        title: "UI/UX Masterclass",
        icon: MonitorPlay,
        href: "/learner/courses/2",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        title: "Sarah Chen",
        icon: Users,
        href: "/learner/instructors/1",
      },
      {
        id: "7",
        title: "Marcus Johnson",
        icon: Users,
        href: "/learner/instructors/2",
      },
    ],
  },
];
    ...
    const handleKeyDown = (e) => {
      ...
      switch (e.key) {
        ...
        case "ArrowUp":
          ...
          setSelectedIndex(
            (prev) =>
              (prev - 1 + (flatItems.length || 1)) % (flatItems.length || 1),
          );
          break;
        case "Enter":
          e.preventDefault();
            ...
            <div className="border-t border-border bg-muted/30 px-4 py-3 flex items-center justify-between text-[11px] text-text-secondary">
              <div className="flex items-center gap-4">
                <span className="flex items-center gap-1">
                  <kbd className="bg-background border border-border px-1.5 rounded">
                    ↑↓
                  </kbd>{" "}
                  to navigate
                </span>
