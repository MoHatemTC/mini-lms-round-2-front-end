...
const Card = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[24px] border border-border bg-card text-card-foreground shadow-premium transition-all duration-300 relative overflow-hidden",
      className,
    )}
    {...props}
  >
...
const CardContent = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("p-6 pt-0 z-10 relative", className)}
    {...props}
  />
));
